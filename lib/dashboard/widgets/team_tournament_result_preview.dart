        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Opacity(opacity: 0.6, child: Text("#${result.matchNumber}")),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Column(
              children: [
                Opacity(
                  opacity: result.homeTeam.result > result.awayTeam.result
                      ? 1
                      : 0.6,
                  child: Row(
                    children: [
                      Expanded(child: Text(result.homeTeam.name)),
                      Text(result.homeTeam.result.toString()),
                    ],
                  ),
                ),
                const SizedBox(height: 8),
                Opacity(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: Text(result.awayTeam.name)),
                      Text(result.awayTeam.result.toString()),
                    ],
                  ),
                ),
              ],
